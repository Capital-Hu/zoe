...
//        List<Document> documents = FileSystemDocumentLoader.loadDocumentsRecursively("C:/Users/a/Desktop/小智医疗/knowledge", new TextDocumentParser());
    ...
    public void testParsePDF() {
        Document document = FileSystemDocumentLoader.loadDocument(
                "C:/Users/a/Desktop/小智医疗/knowledge/医院信息.pdf",
    ...
    public void testDocumentSplitter() {
        ...
        DocumentByParagraphSplitter documentSplitter = new DocumentByParagraphSplitter(
                ...
                30,
                //token分词器：按token计算
                new HuggingFaceTokenizer());//按token计算

        //DocumentByParagraphSplitter documentSplitter = new DocumentByParagraphSplitter(300, 30);//按字符计算
    ...
    public void testTokenCount() {
        ...
        //计算 token 长度
        QwenTokenizer tokenizer = new QwenTokenizer(System.getenv("A_LI_API_KEY"), "qwen-max");
